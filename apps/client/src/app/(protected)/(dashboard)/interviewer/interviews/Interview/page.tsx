...
import { AllFollowUps } from '@app/(protected)/(dashboard)/interviewer/interviews/Interview/_components/AllFollowUps';
import { AppSidebar } from '@app/(protected)/(dashboard)/interviewer/interviews/Interview/_components/SIdeBar';
